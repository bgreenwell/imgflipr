...
For now, just visit the link to your captioned image, it's that easy! Alternatively, you can include the captioned images in R markdown by passing the URL to `knitr::include_graphics()`:
